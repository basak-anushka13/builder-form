...
const connectDB = async (): Promise<boolean> => {
  try {
    ...
    console.warn('⚠️ MongoDB Connection Failed - Using localStorage fallback for development');
    console.warn('   To use MongoDB, ensure MongoDB is running or set MONGODB_URI to a cloud instance');
