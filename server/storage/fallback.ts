...
export class FallbackStorage {
  ...
  static async updateForm(id: string, formData: Partial<FormType>): Promise<FormType | null> {
    const forms = await this.getAllForms()
  ...
  static async createResponse(responseData: Omit<FormResponse, '_id'>): Promise<FormResponse> {
    const responses = await this.getAllResponses()
